...
export function RocketIcon(
  props: React.PropsWithChildren<{ foundParts: IItem[] }>
) {
  const { foundParts = [] } = props;
  ...
  return (
    ...
    >
       <g clip-path="url(#clip0_114_1054)" transform="translate(192, 290)">
        <rect width="62" height="97" />
        <g clip-path="url(#clip1_114_1054)">
          <path
