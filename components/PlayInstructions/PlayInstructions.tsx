...
export function PlayInstructions() {
  ...
  const Instruction = (props: {text: string, img: React.FunctionComponent}) => {
  ...
  return (
    <div className={styles.playInstructions}>
      ...
      <div className={styles.instructions}>
        {instructions.map((int) => <Instruction key={int.id} text={int.text} img={int.img} />)}
      </div>
      <div className={styles.rocket}>
        <p className={styles.text}>Once the player has finished collecting the four pieces, he must land on the central light-blue tile in order to win the game. The first player to do this, will win the game.</p>
      </div>
